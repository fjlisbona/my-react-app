    ...
    <div className="App">
      ...
      <section id="contacta" className="contact">
        ...
        <div className="social-icons">
          <a href="https://www.instagram.com/coachingmindfulpatricialisbona/" target="_blank" rel="noopener noreferrer" className="social-icon">
          ...
          <a href="https://www.facebook.com/patricia.lisbonaroldan" target="_blank" rel="noopener noreferrer" className="social-icon">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
